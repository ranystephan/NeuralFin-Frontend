...
const styles = {
  container: 'flex w-screen h-14 py-2 pl-2 pr-4 lg:px-10 lg:py-3 lg:mb-5 fixed justify-between z-10 text-white bg-transparent backdrop-filter backdrop-blur',
